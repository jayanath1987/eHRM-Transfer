                ...
                <thead>
                    <tr>
                        ...
                        <td scope="col">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Employee Name'), '@transrRequestAdmin', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php echo $sorter->sortLink('tr.id', __('Preferred Division'), '@transrRequestAdmin', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php echo $sorter->sortLink('tr.trans_req_location_pref1', __('Preferred Location'), '@transrRequestAdmin', ESC_RAW); ?>
                        </td>

                        <td scope="col">
                            <?php echo $sorter->sortLink('e.work_station', __('Current Division'), '@transrRequestAdmin', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php echo $sorter->sortLink('e.emp_com_date', __('Working Experience'), '@transrRequestAdmin', ESC_RAW); ?>
                        </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#buttonAdd").click(function() {
            location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/transfer/SaveTransferRequestAdmin')) ?>";
        });
        $("#resetBtn").click(function(){
            location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/transfer/TransferRequestAdmin')) ?>";
        });
